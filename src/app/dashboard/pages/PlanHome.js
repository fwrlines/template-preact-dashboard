...
//const baseClassName = 'page_account_plan_home'
const baseId = 'page_account_plan_home'
...
const mainHeadingProps = {
  ...
  subtitle:<FormattedMessage {...messages.plan_home_subtitle} />,
  //subtitleClassName,
  //subtitleProps:{},

  heading  :<FormattedMessage {...messages.plan_home_title} />,
...
/**
 * Page `AccountPlanHome`
 * Description :
 */
const AccountPlanHome = ({
  history,
  location,
  match
}) => (
...
/*
AccountPlanHome.defaultProps = {
  status: 'neutral',
}
*/


export default AccountPlanHome
